...
class DoomEnv(gym.Env):
    ...
    def __init__(self, scenario_path=None, render_mode=None):
        ...
        wad_path = os.path.join(vzd.scenarios_path, "defend_the_center.wad")
